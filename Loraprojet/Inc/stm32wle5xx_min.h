/**
 ******************************************************************************
 * @file    stm32wle5xx_min.h
 * @brief   Minimal STM32WLE5xx register definitions (project-local)
 ******************************************************************************
 */

#ifndef __STM32WLE5XX_MIN_H
#define __STM32WLE5XX_MIN_H
